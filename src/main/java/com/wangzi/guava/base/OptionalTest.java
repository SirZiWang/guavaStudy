...
import com.wangzi.guava.base.ObjectsTest.People;
...
public class OptionalTest extends TestCase{
	...
	public void test(){
		...
		Optional<String> opt3 = Optional.of("hell world");
	 ...
	 */
	public void test2(){
		Optional<People> opt = Optional.of(null);
		opt.get();
	}
	
	public void test3(){
		Optional<People> opt = Optional.absent();
